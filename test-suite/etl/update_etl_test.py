...
if __name__ == '__main__':
    ...
    m_cursor.execute('DROP SCHEMA IF EXISTS public CASCADE; CREATE SCHEMA IF NOT EXISTS public;')

    a_cursor.execute(
        'DROP SCHEMA IF EXISTS core CASCADE; DROP SCHEMA IF EXISTS datamart CASCADE; CREATE SCHEMA IF NOT EXISTS core; CREATE SCHEMA IF NOT EXISTS datamart;'
    )
